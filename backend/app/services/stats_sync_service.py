...
def map_team_stats_api_data_to_schema(
    api_data: dict, team_id: int, league_id: int, season_id: int
):
...
async def sync_and_save_team_stats(
    ...
    schema_data = map_team_stats_api_data_to_schema(
        response, team_id, league_id, season_id
    )

    existing_stats = (
        team_season_stats_crud.get_team_season_stats_by_team_league_and_season(
            db,
            team_id=team_id,
            league_id=league_id,
            season_id=season_id,
