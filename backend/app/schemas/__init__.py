from .auth_token import (
    Token as Token,
    TokenCreate as TokenCreate,
    TokenUpdate as TokenUpdate,
)
from .coach import (
    Coach as Coach,
    CoachCreate as CoachCreate,
    CoachUpdate as CoachUpdate,
)
...
from .referee import (
    Referee as Referee,
    RefereeCreate as RefereeCreate,
    RefereeUpdate as RefereeUpdate,
)
from .season import (
    Season as Season,
    SeasonCreate as SeasonCreate,
    SeasonUpdate as SeasonUpdate,
)
from .stadium import (
    Stadium as Stadium,
    StadiumCreate as StadiumCreate,
    StadiumUpdate as StadiumUpdate,
)
